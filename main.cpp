...
void displayClock() {
    ...
    drawClockCircle(centerPoint, clockRadius, 1.0, 0.0, 0.0); // red clock face

    drawLine(centerPoint, hourHandTip, 0.0, 0.0, 1.0); // blue hour hand
    drawLine(centerPoint, minuteHandTip, 0.0, 1.0, 0.0); // green minute hand
